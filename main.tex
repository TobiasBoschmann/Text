...
\DeclareSIUnit{\cent}{\text{ct}} 
\DeclareSIUnit{\kiloWh}{\text{kWh}}
\DeclareSIUnit{\kiloW}{\text{kW}} 
\DeclareSIUnit{\megaWh}{\text{MWh}}
\DeclareSIUnit{\a}{\text{a}}
\DeclareSIUnit{\Nmc}{\text{Nmc}}
...
\usepackage{bibunits}
\usepackage{notoccite} %soll Zitate im Preembel verhindern
...
\protect\bibliographystyle{unsrtnat}% This style is not mandatory. Another would be e.g. natdin.
